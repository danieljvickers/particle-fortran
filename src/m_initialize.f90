...
contains
    ...
    subroutine initialize_particles()
        ...
        do i = 1, num_particles
            ...
            orbital_momentum = sqrt(C_G * C_M_s / orbital_radius) * m(i)  ! compute the optimal orbital momentum magnitude from the mass and orbital radius
            ...
            px(i) =  orbital_momentum * y(i) / orbital_radius  ! assign x and y momentum to be in 
            py(i) = -orbital_momentum * x(i) / orbital_radius
